...
def main():
    parser = argparse.ArgumentParser(description="Plot WGAN-GP training losses")
    parser.add_argument("--input", type=str, default="outputs/losses.csv", help="Path to losses CSV")
